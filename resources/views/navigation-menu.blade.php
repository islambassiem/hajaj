    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <!-- Settings Dropdown -->
                <div class="ms-3 relative flex gap-5">
                    <div class="flex gap-5 items-center ms-auto" x-cloak>
                        ...
                        <button @click="darkMode = !darkMode">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-5 block dark:hidden"
                                viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="{{ route('chat.index') }}" class="relative">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-6 hidden dark:inline" fill="#9ca3af"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-6 inline dark:hidden" fill="#6b7280"
                                    viewBox="0 0 16 16">
                                    <path
                                        d="M2.678 11.894a1 1 0 0 1 .287.801 11 11 0 0 1-.398 2c1.395-.323 2.247-.697 2.634-.893a1 1 0 0 1 .71-.074A8 8 0 0 0 8 14c3.996 0 7-2.807 7-6s-3.004-6-7-6-7 2.808-7 6c0 1.468.617 2.83 1.678 3.894m-.493 3.905a22 22 0 0 1-.713.129c-.2.032-.352-.176-.273-.362a10 10 0 0 0 .244-.637l.003-.01c.248-.72.45-1.548.524-2.319C.743 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7-3.582 7-8 7a9 9 0 0 1-2.347-.306c-.52.263-1.639.742-3.468 1.105" />
                                    <path
                            ...
                            @if (\App\Models\User::unreadMessagesCount() > 0)
                                <span
                                    class="absolute -top-1 right-4 rtl:left-4 font-bold px-2 text-xs shrink-0 rounded-full bg-blue-500 text-white">
                                    {{ \App\Models\User::unreadMessagesCount() }}
                                </span>
                            @endif
                        </a>
                    </div>
